report 55002 "Purchase Credit Memo"
{
    DefaultLayout = RDLC;
    RDLCLayout = './SRC/Layouts/PurchaseCreditMemo.rdl';
    ...
    dataset
    {
        dataitem("Purch. Cr. Memo Hdr."; "Purch. Cr. Memo Hdr.")
        {
            ...
            column(TotalTDSAmount; TotalTDSAmount) { } //DJ25042022
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(CompInfoGSTRegNo; CompanyInfo."GST Registration No.") { }
                    ...
                    column(VATRegNoCptn; VATRegNoCptnLbl)
                    {
                         ...
                         column(GSTRegistrationNo; GSTRegistrationNo) { }
                    ...
                    dataitem("Purch. Cr. Memo Line"; "Purch. Cr. Memo Line")
                    {
                        ...
                        column(CGSTComponentCode; CGSTComponentCode) { }
                        column(SGSTComponentCode; SGSTComponentCode) { }
                        column(IGSTComponentCode; IGSTComponentCode) { }
                        ...
                        begin
                            ...
                            //DJ25042022
                            GetCGSTAmount("Purch. Cr. Memo Line".RecordId, CGSTAmount, CGSTPercent, CGSTComponentCode);
                            GetSGSTAmount("Purch. Cr. Memo Line".RecordId, SGSTAmount, SGSTPercent, SGSTComponentCode);
                            GetIGSTAmount("Purch. Cr. Memo Line".RecordId, IGSTAmount, IGSTPercent, IGSTComponentCode);
                        ...
                        begin
                            Clear(TotalLineAmount);//DJ25042022
            ...
            trigger OnAfterGetRecord()
            var
                SalesPersonPurchaser: Record "Salesperson/Purchaser"; //DJ25042022  
            ...
            begin
                ...
                if SalesPersonPurchaser.Get("Purchaser Code") then
                    PurchaserEmail := SalesPersonPurchaser."E-Mail";
                ...
                If TDSEntry.FindSet() then begin
                    ...
                    TotalTDSAmount := TDSEntry."TDS Amount";
                end;
                //DJ25042022
            end;
    ...
    var
        ...
        CGSTAmount: Decimal;
        IGSTAmount: Decimal;
        IGSTComponentCode: Text;
        SGSTComponentCode: Text;
        CGSTComponentCode: Text;
        SGSTPercent: Decimal;
        CGSTPercent: Decimal;
        IGSTPercent: Decimal;
        //DJ25042022
        ...
        GSTRegistrationNo: Label 'GST Registration No.';
        ...
        GrandTotal: Label 'Grand Total'; //DJ25042022
        TDS: Label 'TDS'; //DJ25042022

    //DJ25042022 ++
    procedure GetIGSTAmount(RecID: RecordID; var GSTAmount: Decimal; Var IGSTPercent: Decimal; var IGSTComponentCode: Text)
    var
    ...
    begin
        ...
        if TaxComponent.FindFirst() then begin
            ...
            if TaxTransactionValue.FindFirst() then begin
                ...
                IGSTComponentCode := TaxComponent.Name;
                IGSTPercent := TaxTransactionValue.Percent;
            end;
        end;
    end;

    procedure GetCGSTAmount(RecID: RecordID; var GSTAmount: Decimal; Var CGSTPercent: Decimal; var CGSTComponentCode: Text)
    var
        TaxTransactionValue: Record "Tax Transaction Value";
        GSTSetup: Record "GST Setup";
        i: Integer;
    ...
    begin
        ...
        if TaxComponent.FindFirst() then begin
            ...
            if TaxTransactionValue.FindFirst() then begin
                GSTAmount := TaxTransactionValue.Amount;
                CGSTComponentCode := TaxComponent.Name;
    ...
    procedure GetSGSTAmount(RecID: RecordID; var GSTAmount: Decimal; Var SGSTPercent: Decimal; var SGSTComponentCode: Text)
    var
        TaxTransactionValue: Record "Tax Transaction Value";
        GSTSetup: Record "GST Setup";
        i: Integer;
    ...
    begin
        ...
        if TaxComponent.FindFirst() then begin
            ...
            if TaxTransactionValue.FindFirst() then begin
                GSTAmount := TaxTransactionValue.Amount;
                SGSTComponentCode := TaxComponent.Name;
