report 55003 "GSTR-1 File Form - New"
{
    Caption = 'GSTR-1 File Format - Ad';
    ProcessingOnly = true;
    UseRequestPage = true;
    ...
    var
        ...
        RateTxt: Label 'Rate';
        IGSTRateTxt: Label 'IGST Rate';
        CGSTRateTxt: Label 'CGST Rate';
        SGSTRateTxt: Label 'SGST Rate';
        TotalTaxAmount: Label 'Total Tax Amount';
    ...
    begin
        ...
        TempExcelBuffer.AddColumn(CGSTRateTxt, false, '', true, false, false, '', TempExcelBuffer."Cell Type"::Text);
        TempExcelBuffer.AddColumn(CGSTAmountTxt, false, '', true, false, false, '', TempExcelBuffer."Cell Type"::Text);
        TempExcelBuffer.AddColumn(SGSTRateTxt, false, '', true, false, false, '', TempExcelBuffer."Cell Type"::Text);
        TempExcelBuffer.AddColumn(SGSTAmountTxt, false, '', true, false, false, '', TempExcelBuffer."Cell Type"::Text);
        TempExcelBuffer.AddColumn(IGSTRateTxt, false, '', true, false, false, '', TempExcelBuffer."Cell Type"::Text);
        TempExcelBuffer.AddColumn(IGSTAmountTxt, false, '', true, false, false, '', TempExcelBuffer."Cell Type"::Text);
        TempExcelBuffer.AddColumn(TotalTaxAmount, false, '', true, false, false, '', TempExcelBuffer."Cell Type"::Text);
    ...
    begin
        ...
        GSTR1B2BQuery.SetFilter(GSTR1B2BQuery.GST__, '%1', 0);
        GSTR1B2BQuery.Open();
        ...
        GSTR1B2BQuery.SetRange(Posting_Date, StartDate, EndDate);
        GSTR1B2BQuery.SetFilter(GSTR1B2BQuery.GST_Customer_Type, '%1|%2|%3|%4', "GST Customer Type"::"Deemed Export", "GST Customer Type"::"SEZ Unit", "GST Customer Type"::"SEZ Development", "GST Customer Type"::Registered);
        GSTR1B2BQuery.SetFilter(GSTR1B2BQuery.GST_Jurisdiction_Type, '%1', GSTR1B2BQuery.GST_Jurisdiction_Type::Interstate);
        GSTR1B2BQuery.SetFilter(GSTR1B2BQuery.GST__, '<>%1', 0);
        GSTR1B2BQuery.Open();
        while GSTR1B2BQuery.Read() do
            FillExcelBufferB2B(GSTR1B2BQuery);
    ...
    begin
        ...
        GSTR1B2BGSTPer.SetRange(GSTR1B2BGSTPer.GST_Component_Code, CGSTLbl);
        GSTR1B2BGSTPer.Open();
        IF GSTR1B2BGSTPer.Read() THEN begin
            ...
            CGSTAmount := (ABS(GSTR1B2BQuery.GST_Base_Amount) * GSTR1B2BGSTPer.GST__) / 100;
            TempExcelBuffer.AddColumn(CGSTAmount, false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number);
        end ELSE begin
            TempExcelBuffer.AddColumn(0.00, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number);
        ...
        GSTR1B2BGSTPer.SetRange(Document_No_, GSTR1B2BQuery.Document_No_);
        GSTR1B2BGSTPer.SetRange(GST_Customer_Type, GSTR1B2BQuery.GST_Customer_Type);
        GSTR1B2BGSTPer.SetRange(GSTR1B2BGSTPer.GST_Component_Code, SGSTLbl);
        GSTR1B2BGSTPer.Open();
        IF GSTR1B2BGSTPer.Read() THEN begin
            // if GSTR1B2BGSTPer.GST_Jurisdiction_Type = GSTR1B2BGSTPer.GST_Jurisdiction_Type::Intrastate then
            //     TempExcelBuffer.AddColumn(2 * GSTR1B2BGSTPer.GST__, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number)
            // else
            TempExcelBuffer.AddColumn(GSTR1B2BGSTPer.GST__, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number);
            SGSTAmount := (ABS(GSTR1B2BQuery.GST_Base_Amount) * GSTR1B2BGSTPer.GST__) / 100;
            TempExcelBuffer.AddColumn(SGSTAmount, false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number);
        end ELSE begin
            TempExcelBuffer.AddColumn(0.00, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number);
            TempExcelBuffer.AddColumn(0.00, false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number);
        end;
        ...
        GSTR1B2BGSTPer.SetRange(Document_No_, GSTR1B2BQuery.Document_No_);
        GSTR1B2BGSTPer.SetRange(GST_Customer_Type, GSTR1B2BQuery.GST_Customer_Type);
        GSTR1B2BGSTPer.SetRange(GSTR1B2BGSTPer.GST_Component_Code, IGSTLbl);
        GSTR1B2BGSTPer.Open();
        ...
        IF GSTR1B2BGSTPer.Read() then begin
            TempExcelBuffer.AddColumn(GSTR1B2BGSTPer.GST__, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number);
            IGSTAmount := (ABS(GSTR1B2BQuery.GST_Base_Amount) * GSTR1B2BGSTPer.GST__) / 100;
            TempExcelBuffer.AddColumn(IGSTAmount, false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number)
        end ELSE begin
            TempExcelBuffer.AddColumn(0.00, false, '', false, false, false, '', TempExcelBuffer."Cell Type"::Number);
            TempExcelBuffer.AddColumn(0.00, false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number);
        end;

        TempExcelBuffer.AddColumn(CGSTAmount + SGSTAmount + IGSTAmount, false, '', false, false, false, '0.00', TempExcelBuffer."Cell Type"::Number);
