report 55001 "Purchase Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = './SRC/Layouts/PurchaseInvoice.rdl';
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Purch. Inv. Line"; "Purch. Inv. Line")
                    {
                        ...
                        begin
                            ...
                            //DJ25042022
                            GetCGSTAmount("Purch. Inv. Line".RecordId, CGSTAmount, CGSTPercent, CGSTComponentCode);
                            GetSGSTAmount("Purch. Inv. Line".RecordId, SGSTAmount, SGSTPercent, SGSTComponentCode);
                            GetIGSTAmount("Purch. Inv. Line".RecordId, IGSTAmount, IGSTPercent, IGSTComponentCode);
